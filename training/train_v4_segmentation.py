...
print(dataset)  # Должно быть Dataset, а не DatasetDict
print(dataset[0]["text"])  # Посмотреть первый пример
print(tokenized_dataset[0])  # Проверить токенизированные данные
